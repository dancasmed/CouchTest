var prosp01_ProspeccionProspeccionFilter =
{
	Search : function (query, callbackSuccess, callbackFail)
	{
		$.ajax({
			type: 'Get',
			url: 'http://10.28.249.211:9001/prosp01/Filters/search/' + encodeURI(query) + '',
	...
	SearchBy : function (property, query, callbackSuccess, callbackFail)
	{
		$.ajax({
			type: 'Get',
			url: 'http://10.28.249.211:9001/prosp01/Filters/searchby/' + encodeURI(property) + '/' + encodeURI(query) + '',
			contentType: 'application/json',
			dataType: 'json',
	...
	Create : function (obj, callbackSuccess, callbackFail)
	{
		$.ajax({
			type: 'Post',
			url: 'http://10.28.249.211:9001/prosp01/Filters/new',
			contentType: 'application/json',
			dataType: 'json',
	...
	Read : function (elasticId, callbackSuccess, callbackFail)
	{
		$.ajax({
			type: 'Get',
			url: 'http://10.28.249.211:9001/prosp01/Filters/' + encodeURI(elasticId) + '',
			contentType: 'application/json',
			dataType: 'json',
