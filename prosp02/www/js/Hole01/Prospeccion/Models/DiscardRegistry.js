var prosp01_ProspeccionDiscardRegistry =
{
	Search : function (query, callbackSuccess, callbackFail)
	{
		$.ajax({
			type: 'Get',
			url: 'http://10.28.249.211:9001/prosp01/DiscardRegistries/search/' + encodeURI(query) + '',
...
headers: { "Auth-Session" : SessionManager.SessionToken },
	...
	SearchBy : function (property, query, callbackSuccess, callbackFail)
	{
		$.ajax({
			type: 'Get',
			url: 'http://10.28.249.211:9001/prosp01/DiscardRegistries/searchby/' + encodeURI(property) + '/' + encodeURI(query) + '',
			contentType: 'application/json',
			dataType: 'json',
headers: { "Auth-Session" : SessionManager.SessionToken },
	...
	Create : function (obj, callbackSuccess, callbackFail)
	{
		$.ajax({
			type: 'Post',
			url: 'http://10.28.249.211:9001/prosp01/DiscardRegistries/new',
			contentType: 'application/json',
			dataType: 'json',
headers: { "Auth-Session" : SessionManager.SessionToken },
	...
	Read : function (elasticId, callbackSuccess, callbackFail)
	{
		$.ajax({
			type: 'Get',
			url: 'http://10.28.249.211:9001/prosp01/DiscardRegistries/' + encodeURI(elasticId) + '',
			contentType: 'application/json',
			dataType: 'json',
headers: { "Auth-Session" : SessionManager.SessionToken },
