var hole01_BusinessHole.Services.Business.Models.Naics.EconomicUnit =
{
	Search : function (query, callbackSuccess, callbackFail)
	{
		$.ajax({
			type: 'Get',
			url: 'http://10.28.249.211:6662/Business/Naics/EconomicUnits/search/' + encodeURI(query) + '',
	...
	SearchBy : function (property, query, callbackSuccess, callbackFail)
	{
		$.ajax({
			type: 'Get',
			url: 'http://10.28.249.211:6662/Business/Naics/EconomicUnits/searchby/' + encodeURI(property) + '/' + encodeURI(query) + '',
			contentType: 'application/json',
			dataType: 'json',
	...
	Create : function (obj, callbackSuccess, callbackFail)
	{
		$.ajax({
			type: 'Post',
			url: 'http://10.28.249.211:6662/Business/Naics/EconomicUnits/new',
			contentType: 'application/json',
			dataType: 'json',
	...
	Read : function (elasticId, callbackSuccess, callbackFail)
	{
		$.ajax({
			type: 'Get',
			url: 'http://10.28.249.211:6662/Business/Naics/EconomicUnits/' + encodeURI(elasticId) + '',
			contentType: 'application/json',
			dataType: 'json',
