var hole01_PlacesHole.Services.Places.Models.Country =
{
	Search : function (query, callbackSuccess, callbackFail)
	{
		$.ajax({
			type: 'Get',
			url: 'http://10.28.249.211:6661/Places/Countries/search/' + encodeURI(query) + '',
	...
	SearchBy : function (property, query, callbackSuccess, callbackFail)
	{
		$.ajax({
			type: 'Get',
			url: 'http://10.28.249.211:6661/Places/Countries/searchby/' + encodeURI(property) + '/' + encodeURI(query) + '',
			contentType: 'application/json',
			dataType: 'json',
	...
	Create : function (obj, callbackSuccess, callbackFail)
	{
		$.ajax({
			type: 'Post',
			url: 'http://10.28.249.211:6661/Places/Countries/new',
			contentType: 'application/json',
			dataType: 'json',
	...
	Read : function (elasticId, callbackSuccess, callbackFail)
	{
		$.ajax({
			type: 'Get',
			url: 'http://10.28.249.211:6661/Places/Countries/' + encodeURI(elasticId) + '',
			contentType: 'application/json',
			dataType: 'json',
